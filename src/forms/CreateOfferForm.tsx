...
export default function CreateOfferForm() {
    ...
    const [validityEndDate, setValidityEndDate] = React.useState(defaultDate);
    const [cityName, setCityName] = React.useState("")
    const [latitude, setLatitude] = React.useState(13.0827)
    const [longitude, setLongitude] = React.useState(80.2707)
    const [pin, setPin] = React.useState<any>([])
    const [contractTypeValue, setContractTypeValue] = React.useState<any>("CDI")
